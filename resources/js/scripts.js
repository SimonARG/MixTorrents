...
// Show the user menu dropdown and highlight the button
const userBtn = document.querySelector(".user-btn");
const userDrop = document.querySelector(".user-dropdown");

userBtn.addEventListener('click', function () {
    userDrop.classList.toggle("drop-show");
    userBtn.classList.toggle("user-btn--active");
});

// Close the user menu dropdown menu if the user clicks outside of it
window.addEventListener('click', function (event) {
    if (!event.target.closest('.user-drop')) {
        if (userDrop.classList.contains('drop-show')) {
            userDrop.classList.remove('drop-show');
...
if (document.querySelector("#acc-del")) {
    ...
    accDeleteForm.addEventListener("submit", function (event) {
        event.preventDefault();
        accDelBtn.style.backgroundColor = "var(--btn-red)"
        accDelBtn.innerHTML = "YOU SURE?";
        accDeleteForm.addEventListener("submit", function () {
            accDeleteForm.submit();
        });
    });
}
...
if (document.querySelector("#up-del")) {
    ...
    upDeleteForm.addEventListener("submit", function (event) {
        event.preventDefault();
        upDelBtn.style.backgroundColor = "var(--btn-red)"
        upDelBtn.innerHTML = "YOU SURE?";
        upDeleteForm.addEventListener("submit", function () {
            upDeleteForm.submit();
        });
    });
}
...
if (document.querySelectorAll(".comment-controls")) {
    ...
    comments.forEach(comment => {
        ...
        deleteForm.addEventListener("submit", function (event) {
            ...
            delBtn.style.backgroundColor = "var(--btn-red)"
            delBtn.innerHTML = "YOU SURE?";
