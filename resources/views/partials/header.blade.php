<header>
    <nav class="header-container flex-v f-al-cent">
        <ul id="topnav" class="topnav fill-height">
            ...
            <li class="topnav-item">
                <a class="flex-v f-al-cent" href="{{ route('uploads.create') }}">Upload</a>
            </li>
            <li class="topnav-item">
                <a class="flex-v f-al-cent" href="{{ route('help') }}">Help</a>
            </li>
            <li class="topnav-item">
                <a class="flex-v f-al-cent" href="{{ route('rules') }}">Rules</a>
            </li>
            <li class="topnav-item">
                <a class="flex-v f-al-cent" href="{{ route('about') }}">About</a>
            </li>
