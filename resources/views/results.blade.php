            ...
            <tbody>
                @foreach ($uploads as $upload)
                    ...
                    @endif
                        ...
                        @endauth
                        <td class="col-category table-cat table-td--center"><a href="{{ "http://localhost/MixTorrents/public/search?filter=0&category=" . $upload->category->id . "&search=" }}">{{ $upload->category->category }}</a></td>
